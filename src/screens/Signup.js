      ...
      <Navbar />
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              <label htmlFor="email" className="text1" >Email address</label>
              <input type="email" className="form-control" name='email' value={credentials.email} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
              <label htmlFor="address" className="text1">Address</label>
              <fieldset>
            ...
            <div className="m-3">
              <label htmlFor="exampleInputPassword1" className="text1">Password</label>
